...
import logo from "@/assets/images/cat_94471.png";

import { FaGoogle } from "react-icons/fa";
import profileDefault from "@/assets/images/default-male.jpg"
    ...
    <nav className='bg-blue-700 border-b border-blue-500'>
          ...
          <div className='flex flex-1 items-center justify-center md:items-stretch md:justify-start'>
            ...
            <div className='hidden md:ml-6 md:block'>
              <div className='flex space-x-2'>
                ...
                <Link
                  href='/pets'
                  className= { `${pathName === '/pets' ? 'bg-black' : ''}
                 text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2` }
                >
                ...
                {isLoggedIn && (<Link
                  href='/pets/add'
                  className= { `${pathName === '/pets/add' ? 'bg-black' : ''}
                 text-white hover:bg-gray-900 hover:text-white rounded-md px-3 py-2` }
                >
      ...
      { isMobileMenuOpen && ( <div id='mobile-menu'>
        <div className='space-y-1 px-2 pb-3 pt-2'>
          ...
          <Link
            href='/pets'
            className={` ${pathName === '/pets' ? 'bg-black' : ''} text-white block rounded-md px-3 py-2 text-base font-medium `}
          >
            Pets
          </Link>
          ...
          {isLoggedIn && (   <Link
            href='/pets/add'
            className={` ${pathName === '/pets/add' ? 'bg-black' : ''} text-white block rounded-md px-3 py-2 text-base font-medium `}
          >
            Add Pets
          </Link>
          )}
